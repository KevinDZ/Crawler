...
func init() {
	...
	orm.RegisterDataBase("default", "mysql", "root:root@tcp(127.0.0.1:3306)/movie?charset=utf8", 30)
...
/*func GetMoviewNameId(movieHtml string) int {
...
/*func GetMovieWriter(movieHtml string) string {
	reg := regexp.MustCompile(`<a href="/celebrity/1028134/">(.*?)</a>`)
}*/